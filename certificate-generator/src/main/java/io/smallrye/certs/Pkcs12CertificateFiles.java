...
public final class Pkcs12CertificateFiles implements CertificateFiles {
    ...
    public Pkcs12CertificateFiles(Path root, String name, boolean client, String password) {
        this.root = root;
        this.name = name;
        this.client = client;
